...
This package [MMCAcovid19](https://github.com/jtmatamalas/MMCAcovid19), written in the [Julia](https://julialang.org) language, implements the epidemic model for COVID-19 developed by a group of reserachers from [Universitat Rovira i Virgili](https://www.urv.cat) and [Universidad de Zaragoza](http://unizar.es) [[1-2](#references)]. The model makes use of a Microscopic Markov Chain Approach (MMCA) to describe mathematically the dynamics of a so-called metapopulation model of epidemic spreading [[3-5](#references)].
...
As is common practice in the description of epidemic spreading, we have considered a set of compartments to describe the different stages of people in front of the disease, selected according to the current knowledge of COVID-19:
...
- Hospitalized requiring ICU (H): critical phase of the disease.
- Deceased (D).
- Recovered (R).

Compartment H is very useful to predict the load of ICU, a critical indicator for health systems
...
The model includes containment measures:

- A fraction of the population confined in households.
- A certain degree of permeability of confined people.
- Reduced mobility.
- Reduced number of contacts.

This package allows to select the date of application of the containment measures, and is flexible enough to apply several combinations of containments at different dates, thus enabling the analysis of different containment policies.
